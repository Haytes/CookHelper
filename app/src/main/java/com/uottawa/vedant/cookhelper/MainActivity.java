...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent advSearch = new Intent(getApplicationContext(), AdvancedSearch.class);
        final Intent myRecipes = new Intent(getApplicationContext(), MyRecipes.class);
        final Intent searchResults = new Intent(getApplicationContext(), SearchResults.class);
